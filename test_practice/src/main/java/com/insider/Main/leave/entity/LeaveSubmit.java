package com.insider.Main.leave.entity;

import com.insider.Main.member.entity.Member;
...
public class LeaveSubmit {
    ...
    @Column(name = "LEAVE_SUB_APPROVER", nullable = false, columnDefinition = "VARCHAR(30)")
