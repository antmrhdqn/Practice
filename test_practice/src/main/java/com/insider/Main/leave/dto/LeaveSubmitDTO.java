package com.insider.Main.leave.dto;

import com.insider.Main.member.dto.MemberDTO;
...
public class LeaveSubmitDTO {
    ...
    private String applicantId;                 // 신청자 사번
    ...
    public LeaveSubmitDTO(int leaveSubNo, int refLeaveSubNo, String applicantId, String applicantName, String approverName, Date leaveSubStartDate, Date leaveSubEndDate, Date leaveSubApplyDate, String leaveSubType, String leaveSubStatus, Date leaveSubProcessDate) {
